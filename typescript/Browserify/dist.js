...
var x = require('arithmetic');
console.log(x.add(1, 2));

var y = require('chessboardjs');
y('board', 'start');
//let board1 = ChessBoard('myBoard', 'start');

console.log("Debug end");

},{"arithmetic":2,"chessboardjs":3}],2:[function(require,module,exports){
'use strict'
...
},{"is-numeric":4}],3:[function(require,module,exports){
/*!
